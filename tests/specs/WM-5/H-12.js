...
module.exports = {
  'H-12 test 0num': function (client) {
    auth
        .login(client);
    ...
    client.setValue('#search-process-form > div.wm-subScroll > div.wm-inner > table > tbody > tr:nth-child(5) > td > span > input', 'aaa')
  ...
  'H-12 test 1num': function (client) {
    auth
        .login(client);
    utils.opendir1(client) // test対象Directoryを開く
    utils.open_mng(client)
  ...
  'H-12 test 21num': function (client) {
    auth
        .login(client);
    utils.opendir1(client) // test対象Directoryを開く
    utils.open_mng(client)
